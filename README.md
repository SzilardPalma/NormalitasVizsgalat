...
- Szimulált kritikus értékek ('criticalValues.xlsx'). A kritikus értékek 1-10 sorai az n = 10, 20, 30, ..., 100-as elemszámú mintára vonatkoznak. Minden elemszámra m = 50 000 darab $\mathcal{N}(0,1)$ eloszlású minta volt szimulálva, ami összesen 500 000 minta. Az eredmények az oszlopok szerint az alábbi tesztekhez tartoznak:
    - Shapiro-Wilk teszt
  ...
  - A tesztekhez tartozó size ('testSize.xlsx'). n = 10, 20, 30, ..., 100-as elemszámú mintára vonatkozóan. Minden elemszámra m = 50 000 darab $\mathcal{N}(0,1)$ eloszlású minta volt szimulálva. A tesztek oszlop szerinti sorrendje megegyezik a kritikus értékek táblázatával:
    - Shapiro-Wilk teszt
    - Shapiro-Francia teszt
    - Anderson-Darling teszt
    - Cramér-von Mises teszt
    ...
    - Vasicek teszt
    - Khí-négyzet teszt
    - (A testSizes.mat és a testSize Matlab függvény segítségével ellenőrizhető a sorrend.)
### Minták
